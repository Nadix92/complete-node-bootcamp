...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFkaXgiLCJhIjoiY2s3N3U2aXplMDRwZDNsbXBndGk4Njd1ayJ9.CWn_TL7WfBKa9Znp13XrIw';
...
var stripe = Stripe('pk_test_SpVGZzgBaEYDGzGlNrlOtQdp00bZJRzXOw');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(tourId); // 2) Create checkout form + charge credit card
